...
export const tickets = [
  { token: "eventpass-demo-ticket", attendeeName: "Camille Moreau", attendeeEmail: "camille.demo@kvportfolio.dev", company: "Studio Moreau", eventName: "KV Client Launch Summit", source: "ClientHub", status: "CONFIRMED", checkedIn: false },
