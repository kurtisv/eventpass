...
export const tickets = [
  { token: "eventpass-demo-ticket", attendeeName: "Client recu", attendeeEmail: "lead@example.com", company: "Projet recu", eventName: "KV Client Launch Summit", source: "ClientHub", status: "CONFIRMED", checkedIn: false },
