...
const copy = {
  fr: {
    ...
    intro: "Le projet complete la serie de huit demos avec inscription publique, billets tokenises, contraintes de capacite et operations admin.",
  ...
  en: {
    ...
    intro: "The project completes the eight-project series with public registration, tokenized tickets, capacity constraints, and admin operations.",
    cta: "Explore events",
    points: [
